...
class _HabitHistoryBottomSheetState extends State<HabitHistoryBottomSheet> {
  ...
  List<DateTime> _generateCalendarDays(int year, int month) {
    ...
    // Add next month days to complete the grid (usually grids are multiples of 7: 35 or 42)
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        // Find latest habit data from viewModel to remain reactive
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (isDone) {
                      ...
                      textStyle = TextStyle(
                        color: isCurrentMonth ? colorScheme.onPrimary : colorScheme.onPrimary.withOpacity(0.7),
                        fontWeight: FontWeight.bold,
                        fontSize: 13,
                      );
                    } else if (isToday) {
                      ...
                      textStyle = TextStyle(
                        color: isCurrentMonth
                            ? (isFuture ? colorScheme.onSurface.withOpacity(0.35) : colorScheme.onSurface)
